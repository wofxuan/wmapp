...
public class AddAlarmActivity extends BaseActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    private static final String KEY_INTERVAL = "Interval_key";
    ...
    private String mActive, mWake, mRing, mInterval;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ID = db.addAlarm(new AlarmModel(mTitle, mTime, mWake, mRepeatType, mRepeatCode, mRing, mActive, mInterval));
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putCharSequence(KEY_INTERVAL, mInterval);
    }
    ...
    public void selectRepeat(View v) {
        ...
        final String[] items = {"只响一次", "每天", "周一至周五", "周六周日", "自定义", AlarmService.TYPE_HOUR};

        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setIcon(R.drawable.ic_view_day_grey600_24dp);
        builder.setTitle("铃响周期");
...
//                editor.commit();
    ...
    private void showIntervalDialog(DialogInterface lastDialog) {
        lastDialog.dismiss();
        final EditText et = new EditText(this);
        et.setText(mInterval);
        new AlertDialog.Builder(this).setTitle("间隔时间(分)")
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (input.equals("")) {
                            Toast.makeText(getApplicationContext(), "间隔时间不能为空！" + input, Toast.LENGTH_LONG).show();
                        }
                        else {
                            mInterval = input;
                            mRepeatType = AlarmService.TYPE_HOUR;
                            mRepeatText.setText(mRepeatType);
                        }
                    }
                })
    ...
    private void saveAlarm() {
                ...
                public void onServiceConnected(ComponentName name, IBinder service) {
                    ...
                    switch (mRepeatType) {
                        ...
                        case AlarmService.TYPE_HOUR:
                            binder.setHourAlarm(getApplicationContext(), mInterval, ID);
                            break;
                        default:
        ...
        intent2.setClass(AddAlarmActivity.this, AlarmClockActivity.class);
