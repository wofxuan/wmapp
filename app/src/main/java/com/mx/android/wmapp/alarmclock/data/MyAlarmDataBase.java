package com.mx.android.wmapp.alarmclock.data;
...
import com.mx.android.wmapp.alarmclock.model.QuestionModel;
...
public class MyAlarmDataBase {
    ...
    public int addAlarm(AlarmModel alarmModel){
        ...
        values.put(KEY_INTERVAL, alarmModel.getInterval());
    ...
    public List<AlarmModel> getAllAlarms(){
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                alarmModel.setInterval(cursor.getString(8));
